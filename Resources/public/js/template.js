...
angular.module('templates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('/templates/main.html',
    ...
    "      </div>\n" +
    "    </div>\n" +
    "    <div ng-if=\"::mainCtrl.allowChangeLanguage\" class=\"col-sm-12 col-md-1\">\n" +
    ...
    "        </div>\n" +
    "        <div ng-repeat=\"file in mainCtrl.getFiles() track by file.id\" ng-click=\"mainCtrl.onClick($event, file)\" ng-class=\"{selected: mainCtrl.selection.isSelectedFile(file.id)}\" class=\"thumb thumb-file img-thumbnail\">\n" +
